;(function (cjs, an) {
	...
	;(lib.resistance_1 = function (mode, startPosition, loop, reversed) {
		...
		this.shape.graphics.f('#0066CC').s().p('A1jKAIAAz/MArHAAAIAAT/g')
		this.shape.setTransform(8, 9.05)
	...
	p.nominalBounds = new cjs.Rectangle(-130, -54.9, 276, 128)
	...
	;(lib.oscilloscope_1 = function (mode, startPosition, loop, reversed) {
		...
		// Слой_1
		this.shape = new cjs.Shape()
		this.shape.graphics.f('#0066CC').s().p('A30LkIAA3HMAvpAAAIAAXHg')
		this.shape.setTransform(12.5, -4.95)
		this.shape._off = true
	...
	p.nominalBounds = new cjs.Rectangle(-140, -78.9, 305, 148)
	...
	;(lib.generator_1 = function (mode, startPosition, loop, reversed) {
		...
		// Слой_1
		this.shape = new cjs.Shape()
		this.shape.graphics.f('#0066CC').s().p('A0TJ7IAAz1MAonAAAIAAT1g')
		this.shape.setTransform(18, 7.55)
		this.shape._off = true
	...
	p.nominalBounds = new cjs.Rectangle(-112, -55.9, 260, 127)
	...
	;(lib.cassette_1 = function (mode, startPosition, loop, reversed) {
		...
		// Слой_1
		this.shape = new cjs.Shape()
		this.shape.graphics.f('#0066CC').s().p('Ay+P8IAA/3MAl9AAAIAAf3g')
		this.shape.setTransform(9.5, 9.05)
		this.shape._off = true
	...
	p.nominalBounds = new cjs.Rectangle(-112, -92.9, 243, 204)
	...
	;(lib._2 = function (mode, startPosition, loop, reversed) {
		...
		this.instance.setTransform(152.15, 144.2, 0.6726, 0.8016)
		new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.cassette_1(), 3)

		this.instance_1 = new lib.resistance_1()
		this.instance_1.setTransform(383.85, 140.1, 0.59, 1.2782, 0, 0, 0, 0.1, 0.1)
